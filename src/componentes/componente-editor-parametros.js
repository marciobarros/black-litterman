var componenteEditorParametros = function() {

  // Template da página de parâmetros
  const template = `
    <div class="container">
  ...
  function salvaParametrosFormulario() {
    ...
    servicoModelo.salvaParametros(aversaoRisco, tau);
    $("#mensagem-parametros").html(`<div class="alert alert-success">✅ Valores salvos com sucesso!</div>`);
  }

  // Função inicial
  function apresenta() {
    const parametros = servicoModelo.pegaParametros();
