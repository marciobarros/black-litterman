var componenteEditorCorrelacao = function() {
  ...
  function geraTabelaMatrizCorrelacao() {
    ...
    var matriz = servicoModelo.pegaCorrelacaoAtivos(ativos)
  ...
  function apresentaResultadoPositivoDefinida() {
      const ativos = servicoModelo.pegaAtivos();
      const matriz = pegaMatrizTabela();
      servicoModelo.salvaCorrelacaoAtivos(ativos, matriz);
