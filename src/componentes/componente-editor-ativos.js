var componenteEditorAtivos = function() {
  let sortConfig = { key: null, direction: "asc" };

  // Template da página de ativos
  const template = `
  ...
  function apresentaTabelaAtivos() {
    let elements = servicoModelo.pegaAtivos();
  ...
  function editaAtivo(index) {
    const el = servicoModelo.pegaAtivos()[index];
  ...
  function atualizaAtivo(e) {
    ...
    servicoModelo.salvaAtivos(ativos);
  ...
  function removeAtivo(index) {
    ...
    servicoModelo.salvaAtivos(elements);
    apresentaTabelaAtivos();
  }
  ...
  return { template, apresenta, editaAtivo, removeAtivo }
}()